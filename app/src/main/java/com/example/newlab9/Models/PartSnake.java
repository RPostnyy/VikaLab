...
public class PartSnake {
    ...
    public Rect getrTop() {
        return new Rect(this.x, this.y-10*Constants.SCREEN_HEIGTH/1920, this.x+GameView.sizeElementMap, this.y);
    }
    ...
    public Rect getrBottom() {
        return new Rect(this.x, this.y + GameView.sizeElementMap, this.x + GameView.sizeElementMap, this.y + GameView.sizeElementMap+10*Constants.SCREEN_HEIGTH/1920);
    }
